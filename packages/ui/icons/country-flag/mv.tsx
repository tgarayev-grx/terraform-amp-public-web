...
export const IconCountryFlagMV = forwardRef<
  SVGSVGElement,
  SVGProps<SVGSVGElement>
>(function IconCountryFlagMV({ className, ...props }, ref) {
  return (
    <svg
      ref={ref}
      ...
      {...props}
    >
      <g clipPath="url(#clip0_161_33296)">
        <path
          d="M12 24C18.6274 24 24 18.6274 24 12C24 5.37258 18.6274 0 12 0C5.37258 0 0 5.37258 0 12C0 18.6274 5.37258 24 12 24Z"
          fill="#D80027"
        />
        <path
          d="M19.826 6.26074H4.17383V17.739H19.826V6.26074Z"
          fill="#6DA544"
        />
        <path
...
IconCountryFlagMV.displayName = "IconCountryFlagMV";
