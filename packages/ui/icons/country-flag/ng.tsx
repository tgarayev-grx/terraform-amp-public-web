...
export const IconCountryFlagNG = forwardRef<
  SVGSVGElement,
  SVGProps<SVGSVGElement>
>(function IconCountryFlagNG({ className, ...props }, ref) {
  return (
    <svg
      ref={ref}
      ...
      {...props}
    >
      <g clipPath="url(#clip0_161_33278)">
        <path
...
IconCountryFlagNG.displayName = "IconCountryFlagNG";
