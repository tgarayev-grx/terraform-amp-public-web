...
export const IconCountryFlagNL = forwardRef<
  SVGSVGElement,
  SVGProps<SVGSVGElement>
>(function IconCountryFlagNL({ className, ...props }, ref) {
  return (
    <svg
      ref={ref}
      ...
      {...props}
    >
      <g clipPath="url(#clip0_161_33396)">
        <path
...
IconCountryFlagNL.displayName = "IconCountryFlagNL";
