...
export const IconCountryFlagAM = forwardRef<
  SVGSVGElement,
  SVGProps<SVGSVGElement>
>(function IconCountryFlagAM({ className, ...props }, ref) {
  return (
    <svg
      ref={ref}
      ...
      {...props}
    >
      <g clipPath="url(#clip0_161_33314)">
        <path
...
IconCountryFlagAM.displayName = "IconCountryFlagAM";
