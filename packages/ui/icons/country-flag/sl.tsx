...
export const IconCountryFlagSL = forwardRef<
  SVGSVGElement,
  SVGProps<SVGSVGElement>
>(function IconCountryFlagSL({ className, ...props }, ref) {
  return (
    <svg
      ref={ref}
      ...
      {...props}
    >
      <g clipPath="url(#clip0_161_33376)">
        <path
...
IconCountryFlagSL.displayName = "IconCountryFlagSL";
