...
export const IconCountryFlagFI = forwardRef<
  SVGSVGElement,
  SVGProps<SVGSVGElement>
>(function IconCountryFlagFI({ className, ...props }, ref) {
  return (
    <svg
      ref={ref}
      ...
      {...props}
    >
      <g clipPath="url(#clip0_161_33351)">
        <path
...
IconCountryFlagFI.displayName = "IconCountryFlagFI";
