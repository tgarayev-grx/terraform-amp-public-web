...
export const IconCountryFlagTO = forwardRef<
  SVGSVGElement,
  SVGProps<SVGSVGElement>
>(function IconCountryFlagTO({ className, ...props }, ref) {
  return (
    <svg
      ref={ref}
      ...
      {...props}
    >
      <g clipPath="url(#clip0_161_33226)">
        <path
...
IconCountryFlagTO.displayName = "IconCountryFlagTO";
