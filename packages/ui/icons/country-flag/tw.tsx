...
export const IconCountryFlagTW = forwardRef<
  SVGSVGElement,
  SVGProps<SVGSVGElement>
>(function IconCountryFlagTW({ className, ...props }, ref) {
  return (
    <svg
      ref={ref}
      ...
      {...props}
    >
      <g clipPath="url(#clip0_161_33254)">
        <path
        ...
        />
        <path
          d="M6.84897 9.25653C8.08262 9.25653 9.0827 8.25645 9.0827 7.0228C9.0827 5.78914 8.08262 4.78906 6.84897 4.78906C5.61531 4.78906 4.61523 5.78914 4.61523 7.0228C4.61523 8.25645 5.61531 9.25653 6.84897 9.25653Z"
          fill="#0052B4"
        />
        <path
...
IconCountryFlagTW.displayName = "IconCountryFlagTW";
