...
export const IconCountryFlagUY = forwardRef<
  SVGSVGElement,
  SVGProps<SVGSVGElement>
>(function IconCountryFlagUY({ className, ...props }, ref) {
  return (
    <svg
      ref={ref}
      ...
      {...props}
    >
      <g clipPath="url(#clip0_161_33216)">
        <path
        ...
        />
        <path
          d="M4.5296 21.3897H19.4693C20.5644 20.5175 21.5036 19.458 22.2381 18.2593H1.76074C2.49532 19.458 3.43451 20.5175 4.5296 21.3897Z"
          fill="#338AF3"
        />
        <path
...
IconCountryFlagUY.displayName = "IconCountryFlagUY";
