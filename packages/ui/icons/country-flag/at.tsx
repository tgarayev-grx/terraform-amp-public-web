...
export const IconCountryFlagAT = forwardRef<
  SVGSVGElement,
  SVGProps<SVGSVGElement>
>(function IconCountryFlagAT({ className, ...props }, ref) {
  return (
    <svg
      ref={ref}
      ...
      {...props}
    >
      <g clipPath="url(#clip0_161_33348)">
        <path
...
IconCountryFlagAT.displayName = "IconCountryFlagAT";
