...
export const IconCountryFlagIT = forwardRef<
  SVGSVGElement,
  SVGProps<SVGSVGElement>
>(function IconCountryFlagIT({ className, ...props }, ref) {
  return (
    <svg
      ref={ref}
      ...
      {...props}
    >
      <g clipPath="url(#clip0_161_33437)">
        <path
...
IconCountryFlagIT.displayName = "IconCountryFlagIT";
