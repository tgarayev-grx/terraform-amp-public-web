...
export const IconCountryFlagTH = forwardRef<
  SVGSVGElement,
  SVGProps<SVGSVGElement>
>(function IconCountryFlagTH({ className, ...props }, ref) {
  return (
    <svg
      ref={ref}
      ...
      {...props}
    >
      <g clipPath="url(#clip0_161_33225)">
        <path
...
IconCountryFlagTH.displayName = "IconCountryFlagTH";
