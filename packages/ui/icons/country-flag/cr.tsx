...
export const IconCountryFlagCR = forwardRef<
  SVGSVGElement,
  SVGProps<SVGSVGElement>
>(function IconCountryFlagCR({ className, ...props }, ref) {
  return (
    <svg
      ref={ref}
      ...
      {...props}
    >
      <g clipPath="url(#clip0_161_33380)">
        <path
...
IconCountryFlagCR.displayName = "IconCountryFlagCR";
