...
export const IconCountryFlagGB2 = forwardRef<
  SVGSVGElement,
  SVGProps<SVGSVGElement>
>(function IconCountryFlagGB2({ className, ...props }, ref) {
  return (
    <svg
      ref={ref}
      className={clsx("shrink-nonee", className)}
      viewBox="0 0 24 24"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      {...props}
    >
      <g clipPath="url(#clip0_161_33307)">
        <path
...
IconCountryFlagGB2.displayName = "IconCountryFlagGB2";
