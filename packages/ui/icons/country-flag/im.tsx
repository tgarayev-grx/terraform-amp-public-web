...
export const IconCountryFlagIM = forwardRef<
  SVGSVGElement,
  SVGProps<SVGSVGElement>
>(function IconCountryFlagIM({ className, ...props }, ref) {
  return (
    <svg
      ref={ref}
      ...
      {...props}
    >
      <g clipPath="url(#clip0_161_33295)">
        <path
...
IconCountryFlagIM.displayName = "IconCountryFlagIM";
