...
export const IconCountryFlagGH = forwardRef<
  SVGSVGElement,
  SVGProps<SVGSVGElement>
>(function IconCountryFlagGH({ className, ...props }, ref) {
  return (
    <svg
      ref={ref}
      ...
      {...props}
    >
      <g clipPath="url(#clip0_161_33399)">
        <path
        ...
        />
        <path
          d="M23.2533 16.1738H0.746094C2.44161 20.7434 6.84013 23.9999 11.9997 23.9999C17.1593 23.9999 21.5578 20.7434 23.2533 16.1738Z"
          fill="#496E2D"
        />
        <path
...
IconCountryFlagGH.displayName = "IconCountryFlagGH";
