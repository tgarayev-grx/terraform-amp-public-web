...
export const IconCountryFlagBH = forwardRef<
  SVGSVGElement,
  SVGProps<SVGSVGElement>
>(function IconCountryFlagBH({ className, ...props }, ref) {
  return (
    <svg
      ref={ref}
      ...
      {...props}
    >
      <g clipPath="url(#clip0_161_33433)">
        <path
...
IconCountryFlagBH.displayName = "IconCountryFlagBH";
