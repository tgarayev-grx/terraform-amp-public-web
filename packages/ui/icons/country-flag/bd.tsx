...
export const IconCountryFlagBD = forwardRef<
  SVGSVGElement,
  SVGProps<SVGSVGElement>
>(function IconCountryFlagBD({ className, ...props }, ref) {
  return (
    <svg
      ref={ref}
      ...
      {...props}
    >
      <g clipPath="url(#clip0_161_33405)">
        <path
...
IconCountryFlagBD.displayName = "IconCountryFlagBD";
