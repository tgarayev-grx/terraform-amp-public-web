...
>(function ModalContent({ className, style, children, ...props }, ref) {
  return (
    <Dialog.Content
      ref={ref}
      className={clsx(
        "fixed flex flex-col bg-neutral rounded-2xl focus:outline-none text-neutral-1000",
  ...
  return (
    <Dialog.Close asChild>
      <button
        ...
        type="button"
        className={clsx(
          "top-4 right-4 absolute flex justify-center items-center w-6 h-6 text-neutral-500 hover:text-neutral-700 active:text-neutral-900 transition-colors",
          className
        )}
        {...props}
      >
