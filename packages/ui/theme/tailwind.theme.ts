/**
 * Shared Tailwind color configuration
 * This defines all color tokens that reference CSS variables from the theme
 */
export const tailwindConfigColors = {
  ...
  pea: {
    50: "var(--color-pea-50)",
    100: "var(--color-pea-100)",
    200: "var(--color-pea-200)",
    300: "var(--color-pea-300)",
    400: "var(--color-pea-400)",
    500: "var(--color-pea-500)",
    600: "var(--color-pea-600)",
    700: "var(--color-pea-700)",
